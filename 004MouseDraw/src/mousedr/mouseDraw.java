...
public class mouseDraw extends JFrame{
	...
	JLabel[] colorLabel = new JLabel[19];
	...
	public mouseDraw() {
		setTitle("Artistic Creations by Dillon Bridgewater (October 2018");
		setResizable(false);
		...
		colorLabel[1].setBackground(new Color(153, 0, 0));
		colorLabel[2].setBackground(new Color(255,128,128));
		colorLabel[3].setBackground(new Color(0,204,0));
		...
		colorLabel[7].setBackground(new Color(102,153,255));
		colorLabel[8].setBackground(new Color(0,0,153));
		colorLabel[9].setBackground(new Color(0,255,255));
		colorLabel[10].setBackground(new Color(0,128,128));
		colorLabel[11].setBackground(new Color(153,255,255));
		colorLabel[12].setBackground(new Color(255,0,255));
		colorLabel[13].setBackground(new Color(153,0,153));
		colorLabel[14].setBackground(new Color(255,128,255));
		colorLabel[15].setBackground(new Color(255,255,0));
		colorLabel[16].setBackground(new Color(179,179,0));
		colorLabel[17].setBackground(new Color(255,255,153));;
	...
	protected void colorMousePressed(MouseEvent e) {
	...
	protected void drawPanelMouseReleased(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1
	...
	protected void drawPanelMouseDragged(MouseEvent e) {
		Line2D.Double myLine = new Line2D.Double(xPrevious, yPrevious, e.getX(), e.getY());
		g2D.setPaint(drawColor);
		g2D.draw(myLine);
		xPrevious = e.getX();
	...
	protected void drawPanelMousePressed(MouseEvent e)
	{
	...
	protected void largeMenuItemActionPerformed(ActionEvent e) {
		g2D.setStroke(new BasicStroke(20));
		
	}
	protected void mediumMenuItemActionPerformed(ActionEvent e) {
		g2D.setStroke(new BasicStroke(10));
		
	}
	protected void smallMenuItemActionPerformed(ActionEvent e) {
		g2D.setStroke(new BasicStroke(5));
		
	}
	protected void fineMenuItemActionPerformed(ActionEvent e) {
		g2D.setStroke(new BasicStroke(1));
		
	}
	protected void redMenuItemActionPerformed(ActionEvent e) {
		drawPanel.setBackground(new Color(255,0,0));
		
	}
	protected void yellowMenuItemActionPerformed(ActionEvent e) {
		drawPanel.setBackground(new Color(255,255,0));
		
	}
	protected void blackMenuItemActionPerformed(ActionEvent e) {
